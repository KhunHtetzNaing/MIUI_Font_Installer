...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mifontinstaller", "com.htetznaing.mifontinstaller.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mifontinstaller", "com.htetznaing.mifontinstaller.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mifontinstaller.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
int _h = 0;
 ...
 //BA.debugLineNum = 27;BA.debugLine="Activity.AddMenuItem3(\"Share App\",\"share\",LoadBit";
...
mostCurrent._lb.Initialize(mostCurrent.activityBA,"lb");
 //BA.debugLineNum = 29;BA.debugLine="lb.Text = \"Supported All MIUI Version With 8++\" &";
mostCurrent._lb.setText((Object)("Supported All MIUI Version With 8++"+anywheresoftware.b4a.keywords.Common.CRLF+"No Need #Root"+anywheresoftware.b4a.keywords.Common.CRLF+"No Need Designer Account"));
 //BA.debugLineNum = 30;BA.debugLine="lb.TextColor = Colors.Red";
mostCurrent._lb.setTextColor(anywheresoftware.b4a.keywords.Common.Colors.Red);
 //BA.debugLineNum = 31;BA.debugLine="Activity.AddView(lb,0%x,0%y,100%x,30%y)";
...
mostCurrent._b1.Initialize(mostCurrent.activityBA,"b1");
 //BA.debugLineNum = 35;BA.debugLine="b1.Text = \"Install Custom Font\"";
mostCurrent._b1.setText((Object)("Install Custom Font"));
 //BA.debugLineNum = 36;BA.debugLine="Activity.AddView(b1,20%x,lb.Top+lb.Height,60%x,10%";
...
mostCurrent._b2.Initialize(mostCurrent.activityBA,"b2");
 //BA.debugLineNum = 39;BA.debugLine="b2.Text = \"About\"";
mostCurrent._b2.setText((Object)("About"));
 //BA.debugLineNum = 40;BA.debugLine="Activity.AddView(b2,20%x,b1.Top+b1.Height+1%y,60%x";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._b2.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),(int) (mostCurrent._b1.getTop()+mostCurrent._b1.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (1),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (60),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (10),mostCurrent.activityBA));
 //BA.debugLineNum = 42;BA.debugLine="b3.Initialize(\"b3\")";
mostCurrent._b3.Initialize(mostCurrent.activityBA,"b3");
 //BA.debugLineNum = 43;BA.debugLine="b3.Text = \"More App\"";
mostCurrent._b3.setText((Object)("More App"));
 //BA.debugLineNum = 44;BA.debugLine="Activity.AddView(b3,20%x,b2.Top+b2.Height+1%y,60%x";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._b3.getObject()),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (20),mostCurrent.activityBA),(int) (mostCurrent._b2.getTop()+mostCurrent._b2.getHeight()+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (1),mostCurrent.activityBA)),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (60),mostCurrent.activityBA),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (10),mostCurrent.activityBA));
 //BA.debugLineNum = 46;BA.debugLine="b.Initialize2(\"b\",\"ca-app-pub-4173348573252986/71";
...
if (anywheresoftware.b4a.keywords.Common.GetDeviceLayoutValues(mostCurrent.activityBA).getApproximateScreenSize()<6) { 
 //BA.debugLineNum = 49;BA.debugLine="If 100%x > 100%y Then h = 32dip Else h = 50dip";
...
_h = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50));};
 ...
 //BA.debugLineNum = 51;BA.debugLine="h = 90dip";
_h = anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (90));
 };
 //BA.debugLineNum = 53;BA.debugLine="Activity.AddView(b,0dip,100%y - h,100%x,h)";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._b.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (0)),(int) (anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA)-_h),anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),_h);
 //BA.debugLineNum = 54;BA.debugLine="b.LoadAd";
mostCurrent._b.LoadAd();
 //BA.debugLineNum = 56;BA.debugLine="i.Initialize(\"i\",\"ca-app-pub-4173348573252986/111";
mostCurrent._i.Initialize(mostCurrent.activityBA,"i","ca-app-pub-4173348573252986/1112883353");
 //BA.debugLineNum = 57;BA.debugLine="i.LoadAd";
mostCurrent._i.LoadAd();
 //BA.debugLineNum = 59;BA.debugLine="ad1.Initialize(\"ad1\",100)";
_ad1.Initialize(processBA,"ad1",(long) (100));
 //BA.debugLineNum = 60;BA.debugLine="ad1.Enabled = False";
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 62;BA.debugLine="ad2.Initialize(\"ad2\",60000)";
_ad2.Initialize(processBA,"ad2",(long) (60000));
 //BA.debugLineNum = 63;BA.debugLine="ad2.Enabled = True";
...
anywheresoftware.b4a.objects.IntentWrapper _facebook = null;
 ...
 //BA.debugLineNum = 117;BA.debugLine="Dim Answ As Int";
_answ = 0;
 //BA.debugLineNum = 118;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK Then";
if (_keycode==anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_BACK) { 
 //BA.debugLineNum = 119;BA.debugLine="Answ = Msgbox2(\"If you want to get new updates o";
_answ = anywheresoftware.b4a.keywords.Common.Msgbox2("If you want to get new updates on  Facebook? Please Like "+anywheresoftware.b4a.keywords.Common.CRLF+"Myanmar Android Apps Page!","Attention!","Yes","","No",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"fb.png").getObject()),mostCurrent.activityBA);
 //BA.debugLineNum = 120;BA.debugLine="If Answ = DialogResponse.NEGATIVE Then";
...
if (true) return anywheresoftware.b4a.keywords.Common.False;
 ...
 //BA.debugLineNum = 125;BA.debugLine="If Answ = DialogResponse.POSITIVE Then";
...
try { //BA.debugLineNum = 128;BA.debugLine="Dim Facebook As Intent";
_facebook = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 129;BA.debugLine="Facebook.Initialize(Facebook.ACTION_VIEW, \"fb://";
_facebook.Initialize(_facebook.ACTION_VIEW,"fb://page/627699334104477");
 //BA.debugLineNum = 130;BA.debugLine="StartActivity(Facebook)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_facebook.getObject()));
 } 
       catch (Exception e16) {
			processBA.setLastException(e16); //BA.debugLineNum = 132;BA.debugLine="Dim Facebook As Intent";
_facebook = new anywheresoftware.b4a.objects.IntentWrapper();
 //BA.debugLineNum = 133;BA.debugLine="Facebook.Initialize(Facebook.ACTION_VIEW, \"https";
_facebook.Initialize(_facebook.ACTION_VIEW,"https://m.facebook.com/MmFreeAndroidApps");
 //BA.debugLineNum = 134;BA.debugLine="StartActivity(Facebook)";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_facebook.getObject()));
 };
...
public static String  _ad1_tick() throws Exception{
 //BA.debugLineNum = 86;BA.debugLine="Sub ad1_Tick";
 //BA.debugLineNum = 87;BA.debugLine="If i.Ready Then i.Show Else i.LoadAd";
if (mostCurrent._i.getReady()) { 
mostCurrent._i.Show();}
else {
mostCurrent._i.LoadAd();};
 //BA.debugLineNum = 88;BA.debugLine="ad1.Enabled = False";
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 89;BA.debugLine="End Sub";
return "";
}
public static String  _ad2_tick() throws Exception{
 //BA.debugLineNum = 91;BA.debugLine="Sub ad2_Tick";
 //BA.debugLineNum = 92;BA.debugLine="If i.Ready Then i.Show Else i.LoadAd";
if (mostCurrent._i.getReady()) { 
mostCurrent._i.Show();}
else {
mostCurrent._i.LoadAd();};
...
public static String  _b1_click() throws Exception{
 ...
 //BA.debugLineNum = 67;BA.debugLine="ad1.Enabled = True";
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 68;BA.debugLine="StartActivity(Install)";
...
public static String  _b2_click() throws Exception{
 //BA.debugLineNum = 71;BA.debugLine="Sub b2_Click";
 //BA.debugLineNum = 72;BA.debugLine="ad1.Enabled = True";
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 73;BA.debugLine="StartActivity(About)";
...
anywheresoftware.b4a.phone.Phone.PhoneIntents _p = null;
 //BA.debugLineNum = 76;BA.debugLine="Sub b3_Click";
 //BA.debugLineNum = 77;BA.debugLine="ad1.Enabled = True";
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 78;BA.debugLine="Dim p As PhoneIntents";
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 79;BA.debugLine="StartActivity(p.OpenBrowser(\"http://www.htetznain";
anywheresoftware.b4a.keywords.Common.StartActivity(mostCurrent.activityBA,(Object)(_p.OpenBrowser("http://www.htetznaing.com/search/label/My%20Apps")));
 //BA.debugLineNum = 80;BA.debugLine="End Sub";
return "";
}
public static String  _globals() throws Exception{
 //BA.debugLineNum = 19;BA.debugLine="Sub Globals";
 //BA.debugLineNum = 20;BA.debugLine="Dim b1,b2,b3 As Button";
...
public static String  _i_adclosed() throws Exception{
 //BA.debugLineNum = 112;BA.debugLine="Sub i_AdClosed";
 //BA.debugLineNum = 113;BA.debugLine="i.LoadAd";
mostCurrent._i.LoadAd();
 //BA.debugLineNum = 114;BA.debugLine="End Sub";
return "";
}
public static String  _i_adopened() throws Exception{
 //BA.debugLineNum = 108;BA.debugLine="Sub i_adopened";
 //BA.debugLineNum = 109;BA.debugLine="Log(\"Opened\")";
...
public static String  _i_failedtoreceivead(String _errorcode) throws Exception{
 //BA.debugLineNum = 103;BA.debugLine="Sub i_FailedToReceiveAd (ErrorCode As String)";
 //BA.debugLineNum = 104;BA.debugLine="Log(\"not Received - \" &\"Error Code: \"&ErrorCode)";
anywheresoftware.b4a.keywords.Common.Log("not Received - "+"Error Code: "+_errorcode);
 //BA.debugLineNum = 105;BA.debugLine="i.LoadAd";
mostCurrent._i.LoadAd();
 //BA.debugLineNum = 106;BA.debugLine="End Sub";
return "";
}
public static String  _i_receivead() throws Exception{
 //BA.debugLineNum = 99;BA.debugLine="Sub i_ReceiveAd";
 //BA.debugLineNum = 100;BA.debugLine="Log(\"Received\")";
...
b4a.util.BClipboard _copy = null;
 //BA.debugLineNum = 140;BA.debugLine="Sub share_Click";
 //BA.debugLineNum = 141;BA.debugLine="ad1.Enabled = True";
_ad1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
...
_copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 145;BA.debugLine="copy.setText(\"MIUI Font Install can change font s";
...
_shareit.SetType("text/plain");
 //BA.debugLineNum = 148;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.TEXT\",cop";
_shareit.PutExtra("android.intent.extra.TEXT",(Object)(_copy.getText(mostCurrent.activityBA)));
 //BA.debugLineNum = 149;BA.debugLine="ShareIt.PutExtra (\"android.intent.extra.SUBJECT\",";
